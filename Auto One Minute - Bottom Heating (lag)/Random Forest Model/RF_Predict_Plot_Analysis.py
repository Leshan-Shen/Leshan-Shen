...
RF_Predict_Water_Production = pd.read_csv('RF_Predict_Water_Production.csv',index_col = 0) 
#Read Net_Water_Production.csv file
RF_Predict_Daily_Water_Production = pd.read_csv('RF_Predict_Daily_Water_Production.csv',index_col = 0) 
#Read Auto_Daily_Water_Production.csv file
#%%Types to datetime
...
#types to datetime
RF_Predict_Daily_Water_Production['TIMESTAMP'] = pd.to_datetime(RF_Predict_Daily_Water_Production['TIMESTAMP'])
#types to datetime
#%%
...
#%%
ID0_RF_Predict_Water_Production = RF_Predict_Water_Production[RF_Predict_Water_Production['ID'] == 0]
ID2_RF_Predict_Water_Production = RF_Predict_Water_Production[RF_Predict_Water_Production['ID'] == 2]
ID0_RF_Predict_Water_Production.index = range(0,len(ID0_RF_Predict_Water_Production))
ID2_RF_Predict_Water_Production.index = range(0,len(ID2_RF_Predict_Water_Production))
#%%
ID0_RF_Predict_Daily_Water_Production = RF_Predict_Daily_Water_Production[RF_Predict_Daily_Water_Production['ID'] == 0]
ID2_RF_Predict_Daily_Water_Production = RF_Predict_Daily_Water_Production[RF_Predict_Daily_Water_Production['ID'] == 2]
ID0_RF_Predict_Daily_Water_Production.index = range(0,len(ID0_RF_Predict_Daily_Water_Production))
ID2_RF_Predict_Daily_Water_Production.index = range(0,len(ID2_RF_Predict_Daily_Water_Production))
#%%
fig = go.Figure(data = [go.Scatter(x= ID0_Net_Water_Production['TIMESTAMP'], 
                        ...
                        go.Scatter(x= ID0_RF_Predict_Water_Production['TIMESTAMP'], 
                                   y= ID0_RF_Predict_Water_Production['Predict_Net_Weight'],
                                   name = 'ID0_RF_Predict_Water_Production', mode = 'markers')])
...
fig = go.Figure(data = [go.Scatter(x= ID2_Net_Water_Production['TIMESTAMP'], 
                        ...
                        go.Scatter(x= ID2_RF_Predict_Water_Production['TIMESTAMP'], 
                                   y= ID2_RF_Predict_Water_Production['Predict_Net_Weight'],
                                   name = 'ID2_RF_Predict_Water_Production', mode = 'markers')])
...
fig = go.Figure(data = [go.Bar(x= ID0_Auto_Daily_Water_Production['TIMESTAMP'], 
                        ...
                        go.Bar(x= ID0_RF_Predict_Daily_Water_Production['TIMESTAMP'], 
                                   y= ID0_RF_Predict_Daily_Water_Production['Water_Production'],
                                   name = 'ID0_RF_Predict_Water_Production')])
...
fig = go.Figure(data = [go.Bar(x= ID2_Auto_Daily_Water_Production['TIMESTAMP'], 
                        ...
                        go.Bar(x= ID2_RF_Predict_Daily_Water_Production['TIMESTAMP'], 
                                   y= ID2_RF_Predict_Daily_Water_Production['Water_Production'],
                                   name = 'ID2_RF_Predict_Water_Production')])
fig.update_layout(barmode= 'group')
