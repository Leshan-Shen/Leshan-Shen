# -*- coding: utf-8 -*-
"""
Created on Thu Apr  8 13:35:37 2021
...
filename = ID0_Clean_Data['TIMESTAMP'].iat[1].strftime('ID0 RF Model-%Y-%m-%d') + ID0_Clean_Data['TIMESTAMP'].iat[-1].strftime('-%Y-%m-%d')
...
#%%Save Model in seperate files
filename = ID2_Clean_Data['TIMESTAMP'].iat[1].strftime('ID2 RF Model-%Y-%m-%d') + ID2_Clean_Data['TIMESTAMP'].iat[-1].strftime('-%Y-%m-%d')
